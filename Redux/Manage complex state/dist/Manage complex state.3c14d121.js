...
const initialState = {
    products: (0, _productList.productsList),
    cartItems: [],
    wishList: []
};
...
function reducer(state = initialState, action) {
    ...
    switch(action.type){
        ...
        case WISHLIST_REMOVE_ITEM:
            return {
                ...state,
                wishList: state.wishList.filter((wish)=>wish.productId !== action.payload.productId)
            };
        default:
            return state;
    }
...
//# sourceMappingURL=Manage complex state.3c14d121.js.map
