...
console.dir((0, _redux.createStore));
let initialState = {
    post: 0,
    name: "Anurag",
    city: "Delhi"
...
/* reduxState = reducer(reduxState , {type : 'post/increment'}) */ const store = (0, _redux.createStore)(reducer, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
const myStore = (0, _myRedux.myStore)(reducer);
console.log(store);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "myStore", ()=>myStore);
var _redux = require("redux");
...
},{"redux":"7RvxM","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["n0fw4","kTBnD"], "kTBnD", "parcelRequire94c2", {})

//# sourceMappingURL=React parcel.3c14d121.js.map
